...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    dscores = normalised_mat
    dscores[np.arange(num_train),y] -=1
    dscores /= num_train
    dscores = np.dot(hidden_layer.T,dscores)
    ...
    #dummy = np.zeros_like(dhidden) 
    #dummy[hidden_layer>0]=1
    dhidden[hidden_layer<=0] = 0

    #difflayer1 = 
    #difflayer1 /= num_train
